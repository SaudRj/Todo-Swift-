...
class TodosManager
{
    ...
    {
        let newElement = Todo(title: title, isCompleted: false)
...
class App
{
    var todo : TodosManager
    init(cache: Cache) {
        self.todo = TodosManager(cache: cache)
    }
            ...
            switch command
            {
                ...
                case .toggle:
                    ...
                    if let indexInString = readLine()
                    {
                        ...
                        todo.toggleCompletion(at: indexInInt)
                    }
                break
                case .delete:
